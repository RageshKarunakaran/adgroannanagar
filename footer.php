				...
				<div class="row align-items-center justify-content-between">
					<div class="col-sm-6 col-md-auto text-center text-sm-start">
						<div class="footer1-logo bg-white">
							<a href="./"><img src="assets/img/Adgro Orginal Logo.png" width="250px" alt="Logo"></a>
						</div>
					</div>
					<div class="col-sm-6 col-md-auto pt-20 pt-sm-0 pb-20 pb-sm-0 text-center text-sm-end">
						<div class="footer-social"><a href="#"><i class="fab fa-facebook-f"></i></a> <a href="#"><i class="fab fa-twitter"></i></a> <a href="#"><i class="far fa-basketball-ball"></i></a> <a href="#"><i class="fab fa-linkedin-in"></i></a></div>
					</div>
				</div>
			</div>
		</div>
					...
					<!-- <div class="col-md-6 col-lg-3 col-xl-auto">
						<div class="widget footer-widget">
							...
							<div class="footer-gallery">
								<div class="gal-item">
									<a href="#"><img src="assets/img/bg/banner_2.jpg" width="100px" class=""></a>
								</div>
								<div class="gal-item">
									<a href="#"><img src="assets/img/bg/banner_1.jpg" width="100px" class=""></a>
								</div>
								<div class="gal-item">
									<a href="#"><img src="assets/img/bg/adult-male-getting-hair-loss-treatment.jpg" width="100px" class=""></a>
								</div>
								<div class="gal-item">
									<a href="#"><img src="assets/img/bg/male-going-through-follicular-unit-extraction-process.jpg" width="100px" class=""></a>
								</div>
								<div class="gal-item">
									<a href="#"><img src="assets/img/bg/one.jpg" width="100px" class=""></a>
								</div>
								<div class="gal-item">
									<a href="#"><img src="assets/img/bg/banner_2.jpg" width="100px" class=""></a>
								</div>
			...
			<div class="container">
				<div class="row align-items-center justify-content-between">
					<div class="col-auto text-center text-md-end">
						<p class="mb-0 text-white">Copyright <i class="fal fa-copyright"></i> 2022 <a class="text-white" href="./">AdGro Hair</a>. All Rights Reserved</p>
					</div>
